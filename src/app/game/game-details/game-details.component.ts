...
export class GameDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    // Exemple de données pour un jeu, cela pourrait venir d'un service en réalité
    this.game = {
      name: 'Nom du Jeu',
      players: '2 à 4',
      duration: 60,
      minAge: 12,
      description: 'Description du jeu. C\'est un jeu passionnant qui engage les joueurs dans une aventure inoubliable.',
      theme: 'Aventure',
      styles: ['Stratégie', 'Coopératif', 'Exploration']
    };
  }
}
